...
//	List<Employee> puneCandidates = EmployeeRepository.getEmployeeList().stream().reduce();
	
	
	//14.6 Summing the salaries
	...
	//14.7 departrment names with count of employees
	...
	//14.9 Employee names with duration
	...
	//14.10 employee without department
